...
namespace RTYC.Clock
{
	...
	public class MinuteSecond : Segment
	{
		#region Region - Value
		private DateTime TimeValue = DateTime.MinValue; // override
		/// <summary>Time Value</summary>
		public DateTime Time { get => TimeValue; set { TimeValue = value; DrawAll(); } }
		private Boolean ColonValue = true; // override
		...
		private Int32 VC (Int32 I) // override
		{
			switch (I)
			{
				case 0: return (Int32)Floor(Time.Minute / 10D);
				case 1: return Time.Minute % 10;
				case 3: return (Int32)Floor(Time.Second / 10D);
				case 4: return Time.Second % 10;
				default: return -48;
			}
		}
